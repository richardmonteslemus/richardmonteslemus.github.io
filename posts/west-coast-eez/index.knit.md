...
1.  **Data preparation**: Transforming coordinate reference systems to match spatial extents and resolutions across all datasets. This will alllow us to conduct zonal statistics between them and plot them on a map together.
2.  **Temperature processing**: Calculating mean sea surface temperature (SST) (2008-2012) and converting from Kelvin to Celsius. This ensures we have a robust SST informed by the historical temperatures of the area and is in a temperature people are familar with. 
